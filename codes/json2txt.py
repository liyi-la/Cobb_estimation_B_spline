...
def labelme2yolov2Seg(jsonfilePath="", resultDirPath="", classList=["spine"]):
    """
...
if __name__ == "__main__":
    jsonfilePath = r"D:\Project\Xiehe_Spinal_image_stitching\cobb\labeled_spine\json\test"  # 要转换的json文件所在目录
    resultDirPath = r"D:\Project\Xiehe_Spinal_image_stitching\cobb\labeled_spine\txt\test"  # 要生成的txt文件夹
    labelme2yolov2Seg(jsonfilePath=jsonfilePath, resultDirPath=resultDirPath, classList=["spine"])#顺序分别对应0,1,2
